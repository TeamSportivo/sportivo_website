...
function mentorRoleRank(role) {
  ...
  // Other sport heads stay grouped (no scatter), before Event Head
  if (
    r.includes("football head") ||
    r.includes("table tennis head") ||
    r.includes("tabletennis head") ||
    r.includes("chess head") ||
    r.includes("handball head")
  ) {
    return 50;
  }
